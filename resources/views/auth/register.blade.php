                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <p>Ваш логин будет использоваться в адресной строке для ссылки на ваше портфолио</p>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="birthday_date" type="date" class="form-control @error('birthday_date') is-invalid @enderror" name="birthday_date" required>
